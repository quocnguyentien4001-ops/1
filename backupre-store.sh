Đã dùng 86% bộ nhớ … Nếu hết bộ nhớ, thì bạn không thể lưu tệp vào Drive hoặc sử dụng Gmail. Sử dụng 100 GB dung lượng với giá 45.000 ₫ 19.000 ₫/tháng trong 2 tháng.
#!/bin/bash
